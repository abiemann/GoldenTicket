...
6. For computer claims and routes selected digitally before placement, the public screen names
   ...
   instructions while cards remain covered. During computer turns it also shows the upright board
   and matching gold placement dots in place of the card-reveal button. Place the trains in any order.
