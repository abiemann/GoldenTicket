...
public sealed partial class MainViewModel
{
    ...
    private void OnLocalTrainCardAccepted(SeatId seatId, int? sourceSlot, TrainCardKind kind) =>
    ...
    private void OnLocalDestinationCardsAccepted(SeatId seatId, int count) =>
        NotifyCardDrawn(new(seatId, CardFlightSource.DestinationPile, count: count));

    private void NotifyCardDrawn(CardFlightEventArgs flight)
    {
